...
namespace PharmVerse.Presentation.Categories.Handlers.Events
{
    public class CategoryDeletedEventHandler : INotificationHandler<CategoryDeletedEvent>
    {
        ...
        public CategoryDeletedEventHandler(ILogger<CategoryUpdatedEventHandler> logger)
        {
            _logger = logger;
        }
        ...
        public Task Handle(CategoryDeletedEvent notification, CancellationToken cancellationToken)
        {
            ...
            _logger.LogInformation($"Category Updated Event: {domainEvent.GetType().Name} succeeded for Category with Name:" +
